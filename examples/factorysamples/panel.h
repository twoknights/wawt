...
// Start Samples:
panel({}).text(S("Default Panel")).charSizeGroup(1_Sz),
panel({}).text(S("+ 0.5% Border")).charSizeGroup(1_Sz),
panel({}, panelFill).text(S("+ Fill Option")).charSizeGroup(1_Sz),
panel({}, panelFill).text(S("+ 0.5% & Fill Option")).charSizeGroup(1_Sz)));
// End Samples.
