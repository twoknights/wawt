...
class Screen {
  ...
  public:
    ...
    constexpr static const Normalize kOUTER  = Normalize::eOUTER;
    constexpr static const Normalize kMIDDLE = Normalize::eMIDDLE;
    constexpr static const Normalize kINNER  = Normalize::eINNER;
